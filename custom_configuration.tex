...
\title{Deep Learning Based Low-Latency Breast Ultrasound Video Tumor Detection}
\subtitle{A Lightweight Computer-Aided Diagnosis Approach}

% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{Djupinlärningsbaserad låglatensdetektering av tumörer i videosekvenser från bröstultraljud}
\altsubtitle{En lättviktig metod för datorstödd diagnostik}
...
% \degreeName{Bachelors degree} or \degreeName{Degree of Master of Science in Engineering}
...
\supervisorAsLastname{Mushtaq}
\supervisorAsFirstname{Efa}
\supervisorAsEmail{emus@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
\supervisorAsKTHID{12345678}
...
\supervisorBsLastname{Yang}
\supervisorBsFirstname{Zhikai}
\supervisorBsEmail{zhikai@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
\supervisorBsKTHID{12345678}
\supervisorBsSchool{\schoolAcronym{CBH}}
\supervisorBsDepartment{Biomedical Imaging}
% other for a supervisor outside of KTH add their organization info
...
\examinersKTHID{12345678}
\examinersSchool{\schoolAcronym{EECS}}
\examinersDepartment{Media Technology and Interaction Design}
